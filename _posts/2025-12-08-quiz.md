...
categories: [大模型应用]
tags: [transformer, attention, NLP, LLM, interview]
description: 整理大模型面试中常见的 Transformer、LLaMA、Attention、Norm、训练、推理和分布式训练问题，作为复习清单使用。
image:
  path: /assets/images/posts/placeholders/llm.svg
  alt: 大模型面试题文章封面
mermaid: true
math: true
---
